...
public class VisTracker implements VisionPipeline {
	...
	@Override	public void process(Mat source0) {
		...
		double blurRadius = 4.637184354165487;
		blur(blurInput, blurType, blurRadius, blurOutput);

		// Step HSV_Threshold0:
		Mat hsvThresholdInput = blurOutput;
		double[] hsvThresholdHue = {37.23021582733813, 92.40059354770233};
		double[] hsvThresholdSaturation = {0.0, 54.829351535836174};
		double[] hsvThresholdValue = {193.74627278971963, 255.0};
		...
		double[] filterContoursSolidity = {89.568345323741, 100.0};
