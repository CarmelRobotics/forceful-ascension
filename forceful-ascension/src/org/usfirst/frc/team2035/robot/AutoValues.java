...
public class AutoValues { 
	...
	public static final double DEFAULT_TURN_SPEED = 0.7;
	public static final double DEFAULT_MOVE_SPEED = 0.8;
	public static final double SLOW_MOVE_SPEED = 0.6;
	
	public static final double TURN90_RIGHT_INCHES = 100; //20
	public static final double TURN90_RIGHT_SPEED = 0.7;
	
	public static final double TURN90_LEFT_INCHES = -40;
	...
	public static final double SWITCHFRONT_APPROACH_INCHES = 45; //right-switch-front
	public static final double SWITCHFRONT_APPROACH_SPEED = 0.5;
	
	public static final double RIGHTSWITCHFRONT_LEFTSWITCHFRONT_INCHES = 100; //right-switch-front
